...
void CrsfSerial::begin(uint32_t baud)
{
    if (baud != 0)
        ...
        // _port.begin(_baud, SERIAL_8N1, 5, 6, false); // xiao esp32s3
        _port.begin(_baud, SERIAL_8N1, 37, 39, false); // wemos esp32s2
        // _port.begin(_baud, SERIAL_8N1, 44, 43, false); // wemos s3 mini esp32s3
}
