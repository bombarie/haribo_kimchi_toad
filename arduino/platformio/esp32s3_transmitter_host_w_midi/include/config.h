...
const int analogInPinAileron = 8;
const int analogInPinElevator = 7;
const int analogInPinThrottle = 3;
const int analogInPinRudder = 9;
const int VOLTAGE_READ_PIN = 11;

// pins that used for the switch
const int DIGITAL_PIN_SWITCH_ARM = 1;  // Arm switch
const int DIGITAL_PIN_SWITCH_AUX2 = 2; //
const int DIGITAL_PIN_SWITCH_AUX3 = 4;  //
...
const int DIGITAL_PIN_BUZZER = 10;
//----- Voltage monitoring -------------------------
