...
void CRSF::begin() {
    ...
    // port.begin(SERIAL_BAUDRATE, SERIAL_8N1, 37, 39, false); // wemos s2 mini esp32s2
    port.begin(SERIAL_BAUDRATE, SERIAL_8N1, 44, 43, false); // wemos s3 miniesp32s3
    // port.begin(SERIAL_BAUDRATE, SERIAL_8N1, 16, 17, false); // esp32c3
}
